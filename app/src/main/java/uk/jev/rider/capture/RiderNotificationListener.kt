        ...
        getSharedPreferences("jev_rider", Context.MODE_PRIVATE)
            ...
            .putString(
                ...
                buildString {
                    ...
                    appendLine("£/mile: ${recommendation.estimatedPoundsPerMile ?: "unknown"}")
                    appendLine("£/hour: ${recommendation.estimatedPoundsPerHour ?: "unknown"}")
                    appendLine("Required avg speed: ${recommendation.requiredAverageSpeedMph ?: "unknown"} mph")
                    appendLine("19 mph theoretical min ride: ${recommendation.theoreticalMinimumRideMinutes ?: "unknown"} min")
